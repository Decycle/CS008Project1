 ...
 *************************************************************************/
template<class E>
void LinkedList<E>::pop_front() noexcept(false) //PROC- if list is empty
{
 ...
 *************************************************************************/
template<class E>
void LinkedList<E>::pop_back() noexcept(false) //PROC- if list is empty
{
    //PROC-exception if list is empty
    if (isEmpty())
        //PROC- throw
 ...
 *************************************************************************/
template<class E>
const E& LinkedList<E>::front() const noexcept(false)//PROC- if list empty
{
    //PROC- if empty
    if (isEmpty())
 ...
 *************************************************************************/
template<class E>
const E& LinkedList<E>::back() const noexcept(false) //PROC- if list empty
{
    //PROC- if empty
    if (isEmpty())
        //PROC- go through exception
